<?php
	...
	switch($action){
		...
		case 'ajouterNouveauGenre':{
			if ((!empty($_POST['txtLibGenre']))&&(!empty($_POST['lstPersonnes']))) {
				$idGenreNotif = $db->ajouterGenre($_POST['txtLibGenre'], $_POST['lstPersonnes']);
		...
		case 'validerModifierGenre':{
			$db->modifierGenre($_POST['txtIdGenre'], $_POST['txtLibGenre'], $_POST['lstPersonnes']);
