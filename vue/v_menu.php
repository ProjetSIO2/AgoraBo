      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                <li><a href="index.php?uc=gererJeuxVideo&action=afficherJeuxVideo">Jeux</a></li>
			    ...
			    <li><a href="index.php?uc=gererPegis&action=afficherPegis">Pegis</a></li>
                <li><a href="index.php?uc=gererPersonnes&action=afficherPersonnes">Personnes</a></li>
			    <li><a href="index.php?uc=gererTournois&action=afficherTournois">Tournois</a></li>
                <li><a href="index.php?uc=gererEquipements&action=afficherEquipements">Equipements</a></li>
                <li><a href="index.php?uc=gererFormats&action=afficherFormats">Formats</a></li>
                <li><a href="index.php?uc=gererCategories&action=afficherCategories">Categories</a></li>
            </ul>
          </li>
		  <li class="sub-menu">
