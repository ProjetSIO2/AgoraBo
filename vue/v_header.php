...
<head>
  ...
  <!--external css-->
  <script src="https://kit.fontawesome.com/fb67ad31d0.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="web/css/styleTournoi.css">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
            ...
            if (!isset($_SESSION['idUtilisateur'])){
                ...
                echo '<li><a class="logout" href="index.php?uc=deconnexion">Se déconnecter</a></li>';
            }
            ?>
            <!--
            <a href="" class="userAgo">Gandalf LeGris</a>
