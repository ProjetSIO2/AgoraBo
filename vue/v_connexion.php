        ...
        <form class="form-login" method="post" action="index.php?uc=connexion">
            ...
            <div class="login-wrap">
                ...
                <div class="pull-right login-social-link">
                    ...
                    L'attribut data-toggle contient le type d'événement qui va être lié à un bouton data-toggle=modal
                    /* Bouton qui ouvre une fenêtre modale  -->
                ...
                document.getElementById('txtMdp').value : la valeur du champ saisi txtMdp qui est mise à ' ' avant transmission au serveur pour ne pas envoyer le mdp en clair
